        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="bradcaump__inner text-center">
              <h2 class="bradcaump-title">PET ASSIS SERVICES</h2>
...
<div class="wrapper wrapper--w790">
  <div class="card card-5">
    <div class="card-heading">
      <h2 class="title">PET VETERINARY</h2>
    </div>
    <div class="card-body">
      <?php
      if ($_SESSION['usergroup'] == 1) {
        ...
        <div>
          <center>
            <button class="btn btn--radius-2 btn--red"> <a href="petvet.php">PET Veterinary LIST</a></button>
        ...
        <div>
          <center>
            <button class="btn btn--radius-2 btn--red"> <a href="addpetvet.php">Add Pet Veterinary</a></button>
          </center>
        </div>
        <br></br>
        <div>
          <center>
            <button class="btn btn--radius-2 btn--red"> <a href="petvet.php">Manage Pet Veterinary</a></button>
          </center>
        </div> 
        <?php
