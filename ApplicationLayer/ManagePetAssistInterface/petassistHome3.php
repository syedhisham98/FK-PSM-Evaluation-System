...
<div class="wrapper wrapper--w790">
  <div class="card card-5">
    <div class="card-heading">
      <h2 class="title">PET HOTEL SERVICE</h2>
    </div>
    <div class="card-body">
      <?php
      if ($_SESSION['usergroup'] == 1) {
        ...
        <div>
          <center>
            <button class="btn btn--radius-2 btn--red"> <a href="pethotel.php">PET Hotel LIST</a></button>
        ...
        <div>
          <center>
            <button class="btn btn--radius-2 btn--red"> <a href="addpethotel.php">Add Pet Hotel</a></button>
          </center>
        </div>
        <br></br>
        <div>
          <center>
            <button class="btn btn--radius-2 btn--red"> <a href="pethotel.php">Manage Pet Hotel</a></button>
          </center>
        </div> 
        <?php
