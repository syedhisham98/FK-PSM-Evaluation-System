	...
	<div class="wrapper wrapper--w790">
		<div class="card card-5">
			<div class="card-heading">
				...
				<div>
					<center>
                    <button class="btn btn--radius-2 btn--red"> <a href="editProfile.php?<?=$table_id?>id=<?=$row[''.$table_id.'id']?>">Edit</a></button>
                    <button class="btn btn--radius-2 btn--red"> <a href="../ManageLoginInterface/home.php">Back</a></button>
                    <input type="hidden" name="<?=$table_id?>id" value="<?=$row[''.$table_id.'id']?>">
					</center>
				</div>
			</form>
		</center>
